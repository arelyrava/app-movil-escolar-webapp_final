...
export class RegistroMaestrosComponent implements OnInit {
  ...
  ngOnInit(): void {
    // El primer if valida si existe un parámetro 'id' en la URL
    if (this.activatedRoute.snapshot.params['id'] != undefined) {
      ...
      // Al iniciar la vista asignamos los datos del usuario que vienen por @Input()
  ...
  this.maestrosService.actualizarMaestro(this.maestro).subscribe(
    (response) => {
      ...
      // Redirigir a la vista de maestros (ajusta la ruta si es necesario)
      this.router.navigate(["maestros"]);
    },
    (error) => {
      // Manejar errores de la API
