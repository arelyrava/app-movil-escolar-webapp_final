...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'eventos-lista', component: EventosAcademicosScreenComponent},
      { path: 'eventos-registro', component: RegistroEventosAcademicosScreenComponent }, // New route for event registration
      { path: 'eventos-registro/:id', component: RegistroEventosAcademicosScreenComponent }
    ]
  },
  // fallback route
